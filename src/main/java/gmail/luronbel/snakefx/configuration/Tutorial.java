...
public class Tutorial {
    ...
    private final Rectangle[] rect = new Rectangle[100];
    private Rectangle food;
    private final int[] xc = new int[100];
    private final int[] yc = new int[100];
    private int dir = 3;
    ...
    private Rectangle initRect() {
        final Rectangle res = new Rectangle(45, 45);
    ...
    public void start(final Stage primaryStage) {
        ...
        final Scene scene = new Scene(root, 514, 543);
        for (int i = 0; i < 3; i++) {
            rect[i] = initRect();
